...
import app.lightai.helper.performAppTapHapticFeedback
...
import app.lightai.ui.noRippleClickable
...
class NotificationListFragment : Fragment() {
    ...
    private fun NotificationListScreen() {
        ...
        val version by LightAINotificationListener.changeVersion.collectAsState()
                            ...
                            NotificationRow(
                                ...
                                onDismiss = {
                                    if (item.key.isNotEmpty()) {
                                        LightAINotificationListener.dismissNotification(item.key)
                                    }
