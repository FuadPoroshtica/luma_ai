...
import app.lightai.databinding.FragmentAppDrawerBinding
import app.lightai.helper.LightAINotificationListener
import app.lightai.helper.performGestureActionHapticFeedback
import app.lightai.style.SettingsTheme
import app.lightai.style.isDarkTheme
...
class AppDrawerFragment : Fragment() {
    ...
    override fun onViewCreated(
        ...
        viewLifecycleOwner.lifecycleScope.launch {
            LightAINotificationListener.changeVersion.collect {
                val packages = LightAINotificationListener.getActiveNotificationPackages()
    ...
    private fun populateAppList(
        ...
        appAdapter.updateNotifications(LightAINotificationListener.getActiveNotificationPackages())
    }
